...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="fixed top-4 left-4 z-50" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          {languages.map((lang) => (
            <button
              key={lang}

...
export const metadata: Metadata = {
  ...
  title: {
    default: "Outils Gratuits en Ligne - Timer, Calculatrices, Générateurs",
    template: "%s | Outils Gratuits",
  },
  description: "Suite complète d'outils gratuits : Timer Pomodoro, compresseur d'image, générateur UUID, JSON formatter, minificateur CSS/JS, éditeur Markdown, calculatrice scientifique et générateur IBAN. Outils professionnels pour développeurs et travailleurs.",
  keywords: [
    "timer gratuit",
    "pomodoro",
    "compresseur image",
  ...
  authors: [{ name: "Outils Gratuits" }],
  creator: "Outils Gratuits",
  publisher: "Outils Gratuits",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    url: "/",
    siteName: "Outils Gratuits en Ligne",
    title: "Outils Gratuits en Ligne - Timer, Calculatrices, Générateurs",
    description: "Suite complète d'outils gratuits : Timer Pomodoro, compresseur d'image, générateur UUID, JSON formatter, minificateur CSS/JS, éditeur Markdown, calculatrice scientifique et générateur IBAN.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Outils Gratuits en Ligne - Timer, Calculatrices, Générateurs",
    description: "Suite complète d'outils gratuits : Timer Pomodoro, compresseur d'image, générateur UUID, JSON formatter et plus.",
    images: ["/og-image.png"],
    creator: "@worktimer",
  },
